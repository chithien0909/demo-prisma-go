...
func (client *Client) User(params UserWhereUniqueInput) *UserExec {
	ret := client.Client.GetOne(
		...
		"user",
		[]string{"id", "name", "email", "password", "createdAt", "updatedAt", "role"})
...
var CommentFields = []string{"id", "createdAt", "text"}
...
var UserFields = []string{"id", "name", "email", "password", "createdAt", "updatedAt", "role"}
...
var CommentPreviousValuesFields = []string{"id", "createdAt", "text"}
...
var UserPreviousValuesFields = []string{"id", "name", "email", "password", "createdAt", "updatedAt", "role"}
